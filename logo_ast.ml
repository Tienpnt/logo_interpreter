...
(* Version graphique : Turtle_graphic fournit move_fwd, move_bck,  *)
(* turn_right, turn_left, draw, nodraw, reset avec rendu visuel.   *)
(* Ces fonctions remplacent celles de Turtle dans interp_cmd.      *)
open Turtle_graphic
;;
...
let interp_cmd (c : t_cmd) (s : t_state) : t_turtle =
  let (env, t) = s in
  match c with
  | Forward e  -> move_fwd   t (interp_expr env e)   (* Turtle_graphic.move_fwd *)
  | Backward e -> move_bck   t (interp_expr env e)   (* Turtle_graphic.move_bck *)
  | Right e    -> turn_right t (interp_expr env e)   (* Turtle_graphic.turn_right *)
  | Left e     -> turn_left  t (interp_expr env e)   (* Turtle_graphic.turn_left *)
  | PenDown    -> draw   t                           (* Turtle_graphic.draw *)
  | PenUp      -> nodraw t                           (* Turtle_graphic.nodraw *)
  | Clear      -> reset  ()                          (* Turtle_graphic.reset *)
;;
