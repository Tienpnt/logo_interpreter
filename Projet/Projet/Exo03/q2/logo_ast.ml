...
;;
(*-----------------------------------------------------*)
(* interp_bexpr : évalue une comparaison               *)
(*   @param env : environnement (valeurs des variables) *)
(*   @param b   : la comparaison à évaluer              *)
(*   @return    : true si la comparaison est vraie      *)
(*                false sinon                           *)
(*                                                      *)
(* On évalue les deux expressions, puis on applique    *)
(* l'opérateur de comparaison correspondant.           *)
(*-----------------------------------------------------*)
