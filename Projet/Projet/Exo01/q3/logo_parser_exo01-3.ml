...
# 19 "logo_parser_exo01-3.mly"
        int
# 6 "logo_parser_exo01-3.ml"
)
  | IDENT of (
# 20 "logo_parser_exo01-3.mly"
        string
# 11 "logo_parser_exo01-3.ml"
)
  | VAR of (
# 21 "logo_parser_exo01-3.mly"
        string
# 16 "logo_parser_exo01-3.ml"
)
  | AVANCE
  | RECULE
  | GAUCHE
...
open Parsing
let _ = parse_error;;
# 9 "logo_parser_exo01-3.mly"
  (* En-tête OCaml : rien de spécial pour cette version *)
# 33 "logo_parser_exo01-3.ml"
let yytransl_const = [|
  260 (* AVANCE *);
  261 (* RECULE *);
  262 (* GAUCHE *);
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 51 "logo_parser_exo01-3.mly"
      ( print_string "Règle : main -> instr .\n" )
# 122 "logo_parser_exo01-3.ml"
               : unit))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : string) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 61 "logo_parser_exo01-3.mly"
      ( print_string "Règle : instr -> Def IDENT expr\n" )
# 130 "logo_parser_exo01-3.ml"
               : 'instr))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 65 "logo_parser_exo01-3.mly"
      ( print_string "Règle : instr -> Def IDENT expr ; instr\n" )
# 139 "logo_parser_exo01-3.ml"
               : 'instr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'cmd) in
    Obj.repr(
# 69 "logo_parser_exo01-3.mly"
      ( print_string "Règle : instr -> cmd\n" )
# 146 "logo_parser_exo01-3.ml"
               : 'instr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'cmd) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'instr) in
    Obj.repr(
# 73 "logo_parser_exo01-3.mly"
      ( print_string "Règle : instr -> cmd ; instr\n" )
# 154 "logo_parser_exo01-3.ml"
               : 'instr))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 80 "logo_parser_exo01-3.mly"
                   ( print_string "Règle : cmd -> Avance expr\n"  )
# 161 "logo_parser_exo01-3.ml"
               : 'cmd))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 81 "logo_parser_exo01-3.mly"
                   ( print_string "Règle : cmd -> Recule expr\n"  )
# 168 "logo_parser_exo01-3.ml"
               : 'cmd))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 82 "logo_parser_exo01-3.mly"
                   ( print_string "Règle : cmd -> Gauche expr\n"  )
# 175 "logo_parser_exo01-3.ml"
               : 'cmd))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 83 "logo_parser_exo01-3.mly"
                   ( print_string "Règle : cmd -> Droite expr\n"  )
# 182 "logo_parser_exo01-3.ml"
               : 'cmd))
; (fun __caml_parser_env ->
    Obj.repr(
# 84 "logo_parser_exo01-3.mly"
                   ( print_string "Règle : cmd -> Efface\n"       )
# 188 "logo_parser_exo01-3.ml"
               : 'cmd))
; (fun __caml_parser_env ->
    Obj.repr(
# 85 "logo_parser_exo01-3.mly"
                   ( print_string "Règle : cmd -> Dessine\n"      )
# 194 "logo_parser_exo01-3.ml"
               : 'cmd))
; (fun __caml_parser_env ->
    Obj.repr(
# 86 "logo_parser_exo01-3.mly"
                   ( print_string "Règle : cmd -> Deplace\n"      )
# 200 "logo_parser_exo01-3.ml"
               : 'cmd))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : int) in
    Obj.repr(
# 94 "logo_parser_exo01-3.mly"
          ( print_string ("Règle : expr -> INT(" ^ string_of_int _1 ^ ")\n") )
# 207 "logo_parser_exo01-3.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 95 "logo_parser_exo01-3.mly"
          ( print_string ("Règle : expr -> VAR(" ^ _1 ^ ")\n") )
# 214 "logo_parser_exo01-3.ml"
               : 'expr))
(* Entry main *)
